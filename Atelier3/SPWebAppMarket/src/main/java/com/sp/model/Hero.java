...
public class Hero {
	...
	public Hero(int id,Integer owner,String family,String name,String description,String affinity,String imgUrl,int hp,int vitesse,int attack,int defence) {
		super();
	...
	public Hero(int id,Integer owner,String family,String name,String description,String affinity,String imgUrl,
			int hp,int vitesse,int attack,int defence,boolean onSell,int stock,int price) {
